...
const Footer = ({ setIsContactOpen }) => {
  return (
    <footer className="relative z-10 bg-gray-900/50 backdrop-blur-lg border-t border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Empowering careers through cutting-edge technology education and hands-on learning experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/all-courses" className="text-gray-400 hover:text-white transition-colors">
                  All Courses
                </Link>
              </li>
              <li>
