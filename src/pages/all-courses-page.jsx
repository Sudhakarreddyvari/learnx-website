...
const AllCoursesPage = ({ setIsContactOpen }) => {
  ...
  const coursesData = [
    ...
    },
    {
      ...
      shortDescription: "Build modern fullstack applications enhanced by AI. Learn Python, JavaScript, React, Node.js, and AI integration.",
      category: "development",
      rating: 4.9,
      reviewCount: 1200,
      duration: "20 weeks",
      ...
      skills: ["Python", "JavaScript", "React", "Node.js", "AI APIs", "Machine Learning", "Cloud AI"],
    },
    {
      id: 15,
