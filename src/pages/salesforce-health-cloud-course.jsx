...
const SalesforceHealthCloudCourse = ({ setIsContactOpen }) => {
  ...
  const courseData = {
    ...
    placements: {
      companies: [
        { name: "Apollo Hospitals", logo: "https://upload.wikimedia.org/wikipedia/commons/6/6b/Apollo_Hospitals_Logo.png" },
        { name: "Fortis Healthcare", logo: "https://upload.wikimedia.org/wikipedia/commons/2/2e/Fortis_Healthcare_logo.png" },
